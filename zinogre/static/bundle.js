...
/***/ (function(module, exports, __webpack_require__) {
	...
	), document.getElementById("zinogreApp"));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _generatePath2 = __webpack_require__(202);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createBrowserHistory2 = __webpack_require__(174);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _generatePath = __webpack_require__(197);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Locations = __webpack_require__(209);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _LocationService = __webpack_require__(210);

	var _LocationService2 = _interopRequireDefault(_LocationService);

	var _APIService = __webpack_require__(237);

	var _APIService2 = _interopRequireDefault(_APIService);

	var _LocationList = __webpack_require__(239);
	...
	var locationService = new _LocationService2.default();
	...
	var Locations = function (_Component) {
		...
		_createClass(Locations, [{
			...
			value: function componentDidMount() {
				...
				apiService.getAPI().then(function (res) {
					if (res.data) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "col-sm-12" },
							_react2.default.createElement(_LocationList2.default, { locations: this.state.locations }),
							" "
						),
						" "
					),
		...
		_createClass(LocationService, [{
			...
			value: function getLocations() {
				return new Promise(function (resolve, reject) {
					_axios2.default.get("/locations").then(function (response) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jsCookie = __webpack_require__(238);
	...
	var APIService = function () {
		...
		_createClass(APIService, [{
			...
			value: function getAPI() {
				return new Promise(function (resolve, reject) {
					var token = _jsCookie2.default.get("oidc_id_token");
					console.log("session in js " + _jsCookie2.default.get("session"));
					console.log("JSESSIONID in js " + _jsCookie2.default.get("JSESSIONID"));
					console.log("oidc_id_token in js " + _jsCookie2.default.get("oidc_id_token"));
					...
					_axios2.default.get("api", bodyParameters, config).then(function (response) {
						if (response.data) {
							resolve({
								data: response.data
							});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getLocations = function getLocations(locations) {
